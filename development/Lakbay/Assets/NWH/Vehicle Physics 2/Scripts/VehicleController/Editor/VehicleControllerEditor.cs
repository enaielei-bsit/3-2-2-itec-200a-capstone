...
namespace NWH.VehiclePhysics2
{
    ...
    public class VehicleControllerEditor : NVP_NUIEditor
    {
        ...
        private void DrawSettingsTab()
        {
            ...
            {
                drawer.Info($"Current Time.fixedDeltaTime is {Time.fixedDeltaTime}. This will result in 50Hz physics update.\n" +
                            $"For best results use 0.01667f (60Hz) or lower if possible.\n" +
                            $"This setting can be adjusted under Project Settings > Time.", MessageType.Warning);
            }
            ...
            {
                drawer.EmbeddedObjectEditor<NVP_NUIEditor>(vehicleController.stateSettings, drawer.positionRect);
            }
            else
            {
            ...
            drawer.Info(
                "Constrain When Asleep will be disabled when a trailer is attached as constraints do not work" +
                " well with physics joints.");
            drawer.EndSubsection();
