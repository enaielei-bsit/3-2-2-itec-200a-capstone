...
namespace NWH.VehiclePhysics2.Modules
{
    ...
    public class NOSModule : VehicleModule
    {
        ...
        private float _initialEngineVolumeRange;
        ...
        public override void Initialize()
        {
            ...
            _initialEngineVolumeRange = vc.soundManager.engineRunningComponent.volumeRange;
            _wasActive                = active;
        ...
        public override void Update()
        {
            ...
            {
                vc.soundManager.engineRunningComponent.volumeRange = _initialEngineVolumeRange;
            }
        }
        ...
        public float NOSPowerModifier()
        {
            ...
            {
                vc.soundManager.engineRunningComponent.volumeRange = _initialEngineVolumeRange * engineVolumeCoefficient;
            }
