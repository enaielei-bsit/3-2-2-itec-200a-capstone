...
namespace NWH.VehiclePhysics2.Powertrain
{
    ...
    {
        public delegate float CalculateTorque(float angularVelocity, float t, float dt);
        ...
        /// <summary>
        ///     Engine layout / orientation. Either longitudinal or lateral.
        /// </summary>
        [Tooltip(
        ...
        {
            get { return ignition && angularVelocity > _stallAngularVelocity; }
        }
        ...
        /// </summary>
        public float CalculateTorqueElectric(float angularVelocity, float t, float dt)
        {
        ...
        /// </summary>
        public float CalculateTorqueICE(float angularVelocity, float t, float dt)
        {
            ...
            if (angularVelocity > _idleAngularVelocity)
            {
                ...
                lossTorque = throttlePosition > 0.01f ? 0f : maxLossTorque * rpmPercent;
            }
            else
            {
                lossTorque = 0;
        ...
        public void IntegrateDownwards(float t, float dt, int i)
        {
            if (_outputAIsNull)
            {
                return;
            ...
            GeneratedTorque = calculateTorqueDelegate(Wa, t, dt);
            ...
            float Treturned = ForwardStep(GeneratedTorque - Treact, 0, t, dt, i);
