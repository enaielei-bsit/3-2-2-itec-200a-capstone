...
namespace NWH.VehiclePhysics2
{
    ...
    public class VehicleController : Vehicle
    {
        ...
        private void ApplyLowSpeedFixes()
        {
            ...
            if (constrainWhenAsleep && !_isAwake && t + verticalInput < 0.2f && _sleepTimer > 2f)
            {
        ...
        public override void SetMultiplayerInstanceType(MultiplayerInstanceType instanceType)
        {
            #if NVP2_DEBUG
