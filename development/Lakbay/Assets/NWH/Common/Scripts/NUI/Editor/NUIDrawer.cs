    ...
    public class NUIDrawer
    {
        ...
        public bool IsExpanded
        {
            get
            {
                ...
                EditorCache.GetIsExpandedCacheValue(_cachedKey, ref isExpanded);
                return isExpanded;
            }
            set { EditorCache.SetIsExpandedCacheValue(_cachedKey, value); }
        }
        ...
        private void InitializeGUIElements()
        {
            ...
            // Get textures
            _expandedArrow = Resources.Load(NUISettings.resourcesPath + "arrow_expanded") as Texture2D;
            _foldedArrow   = Resources.Load(NUISettings.resourcesPath + "arrow_folded") as Texture2D;
        }
            ...
            bool                                disabled = false)
        {
            ...
            AdvancePosition(GetHeight(GenerateKey(p)) + NUISettings.fieldSpacing);
